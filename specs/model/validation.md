...
| 10 | `wrap_actions.rs` | Gate WRAP_ACTIONS features (onWrapEnter, onWrapTaskRun, onWrapExit, runOnHost) and enforce the single-wrap-layer-per-session rule (RFC 0008) |
